/**
 * Storm Summoning
 * Extracted from raw_data_homecoming with redirect support
 */
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['storm-summoning'] = STORM_SUMMONING_POWERSET;
} else if (typeof window !== 'undefined') {
    window.STORM_SUMMONING_POWERSET = STORM_SUMMONING_POWERSET;
}