...
const DARK_MIASMA_POWERSET = {
    ...
    powers: [
        ...
        },
        {
            ...
            allowedSetCategories: ["Defender Archetype Sets", "Ranged AoE Damage", "Slow Movement", "Stuns", "Universal Damage Sets"],
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['dark-miasma'] = DARK_MIASMA_POWERSET;
} else if (typeof window !== 'undefined') {
    window.DARK_MIASMA_POWERSET = DARK_MIASMA_POWERSET;
}