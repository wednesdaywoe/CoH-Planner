...
export const MANUAL_CHANGELOG_GROUPS: ManualChangelogGroup[] = [
  // ───────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: 'jump-speed-base-mph', message: 'Jump speed was reading about 1.47x too fast: its base was recorded as 21 mph, but 21 is the feet-per-second figure — the same 14.32 mph as running. Hurdle at +190.5% now reads 41.59 mph instead of 61.', type: 'fix' },
      ...
      { id: 'fly-speed-base-mph', message: 'Fly speed had the same units mistake, plus one of its own. Fly\'s base is 21.48 mph, but buffs on top of it are worth 14.32 mph per 100% — they do not scale with fly\'s higher base. An unslotted Swift is +1.95 mph, not +2.93.', type: 'fix' },
    ]
  },
  {
    date: '2026-07-19',
