...
export const SeismicForce: Power = {
  ...
  "grantEdges": [
    {
      "op": "revoke",
      "path": "Sentinel_Ranged.Seismic_Blast.Shockwaves",
      "count": 1,
      "condition": [
        "kSeismicPower",
        "Source.Mode?"
