...
export const DarkBlast: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Negative",1.2602,1,0,"Ranged_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,["enttype","target>","player","eq"],true]
  ]
};
