...
export const Special2: Power = {
  ...
  "autoIssue": false,
  "free": false,
  "description": "You make a sweeping strike with your blades, hitting all foes in a cone in front of you and dealing superior lethal damage to each. This power is the finishing move for the Attack Vitals combination attack.\n\nAttack Vitals: Ablating Strike > Vengeful Slice > Sweeping Strike.",
  ...
  "atoms": [
    ...
    ["Damage","Lethal",1.7,1,0,"Melee_InherentDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,0.15000000596046448,null,null,null,null,null,null,["enttype","target>","critter","eq"],null,null,null,null,null,null,null,null,null,"CritLarge,ScrapperCrit_AoE"],
    ...
    ["Damage","Lethal",1.3554,1,0,"Melee_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,0.15000000596046448,null,null,null,null,null,null,["enttype","target>","player","eq"],true,null,null,null,null,null,null,null,null,"CritLarge,ScrapperCrit_AoE"],
    ...
    ["Damage","Fire",0.09,1,4.1,"Melee_Damage","Abs","Magnitude","Target","Any",true,"Stack",2,null,1,0,null,null,null,null,null,null,["kDD_BonusDoTMode_2","Source.Mode?"],true,null,null,null,null,null,null,null,null,"FieryEmbrace",null,null,null,0.5]
  ],
  "conditionalEffects": [
    {
