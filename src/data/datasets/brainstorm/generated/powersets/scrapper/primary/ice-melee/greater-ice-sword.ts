...
export const GreaterIceSword: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Cold",2.2002,1,0,"Melee_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,0.05000000074505806,null,null,null,null,null,null,["enttype","target>","player","eq"],true,null,null,null,null,null,null,null,null,"CritPlayer,ScrapperCrit_ST"]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
