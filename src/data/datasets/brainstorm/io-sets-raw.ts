/**
 * HC Brainstorm IO Set data — extracted from the committed bin-crawler export.
 *
 * Auto-generated by `scripts/extract-rebirth-io-sets-v2.py --dataset brainstorm`.
 * Do not hand-edit.
 *
 * Source: exported_powers/brainstorm/ (produced by `bin_crawler.export_powers`)
