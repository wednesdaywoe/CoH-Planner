/**
 * Veracity IO Set data — extracted from live Veracity bins.
 *
 * Auto-generated by `scripts/extract-rebirth-io-sets-v2.py --dataset veracity`.
 * Do not hand-edit.
 *
 * Source: Veracity/assets/bin.pigg
