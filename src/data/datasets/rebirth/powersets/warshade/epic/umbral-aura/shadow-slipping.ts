...
import { ShadowSlipping as base } from '@/data/datasets/rebirth/generated/powersets/warshade/epic/umbral-aura/shadow-slipping';
import { overrides } from '@/data/datasets/rebirth/overrides/powersets/warshade/epic/umbral-aura/shadow-slipping';

export const ShadowSlipping: Power = withOverrides(base, overrides);
