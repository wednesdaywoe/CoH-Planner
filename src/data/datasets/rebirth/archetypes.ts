...
// buffDebuffModifier are VESTIGIAL fallbacks (the calc reads the binary
// named_tables for every {scale, table} effect — all of them — so these are
// never read). Rebirth keeps the pre-2020 Tanker damageModifier 0.8/0.5 (its
// binary tables confirm it), unlike HC's reworked 0.95/0.8. See
