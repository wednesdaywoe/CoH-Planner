 ...
 *     1499 at L50, where HC buffed it to 1606.) baseThreat is also binary-
 *     sourced (Phase 2 header scalar — caught the hand-port's wrong Guardian
 *     threat, 1.0 → binary 2.0). Damage modifiers and the other scalars below
 *     remain hand-curated — see ARCHETYPE-DEFS-BINARY-SOURCING.md.
 */
...
// baseThreat (Phase 2 header scalar) are now binary-sourced from the Rebirth
// classes.bin (Parse6): ARCHETYPE_BINARY_STATS is generated by
// export_classes.py -> convert-archetypes.cjs and spread into each archetype's
// `stats` below. Remaining scalars stay hand-curated -- see
