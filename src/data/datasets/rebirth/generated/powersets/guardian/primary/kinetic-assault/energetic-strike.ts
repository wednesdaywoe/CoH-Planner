...
export const EnergeticStrike: Power = {
  ...
  "atoms": [
    ...
    ["Mez","CombatPhase",1,1,0,"Melee_Ones","Cur","Magnitude","Self","Any",false,"Ignore",2,null,null,0.20000000298023224,null,true,null,null,null,null,"Temporary_Powers.Temporary_Powers.Kinetic_Assault_Impulse source.ownPowerNum? 5 >= Guardian_Assault.Kinetic_Assault.Coalescence source.ownPower? &&",true],
