...
export const PhoenixAwakening: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Untouchable",10,1,15,"Ranged_Ones","Cur","Magnitude","Self","Any",false,"Replace",2,null,null,1,null,true,null,null,null,null,"cur.kHitPoints target> 1 <"],
    ["Heal",null,1,1,1,"Melee_Ones","Cur","Magnitude","Self","Any",false,"Stack",2,null,1.5,1,null,null,null,null,null,null,"cur.kHitPoints target> 1 <"],
    ["Endurance",null,1,1,1,"Melee_Ones","Cur","Magnitude","Self","Any",false,"Stack",2,null,1.5,1,null,null,null,null,null,null,"cur.kHitPoints target> 1 <"],
    ["EntCreate",null,1,1,90,"Melee_Ones","Abs","Magnitude","Target","Any",false,"Replace",2,null,null,1,null,true,null,null,null,null,"cur.kHitPoints target> 1 <"]
  ],
  "conditionalEffects": [
    {
      "id": "conditional",
