...
export const Hypothermia: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Sleep",6,3,15.1,"Ranged_Sleep","Cur","Duration","Target","PvE",true,"Stack",2,null,3,0.6000000238418579,null,null,null,null,null,null,"enttype target> critter eq kStealth source> 0.5 > &&",true],
    ["Mez","Sleep",4,1,15.1,"Ranged_Ones","Cur","Duration","Target","PvP",true,"Stack",2,null,3,0.6000000238418579,null,null,null,null,null,null,"enttype target> player eq kStealth source> 0.5 > &&",true],
    ...
    ["Mez","Sleep",3,4,15.1,"Ranged_Ones","Cur","Duration","Target","PvP",true,"Stack",2,null,3,0.75,null,null,null,null,null,null,"enttype target> player eq Temporary_Powers.Temporary_Powers.Water_Control_Drowning target.ownPower? &&",true],
