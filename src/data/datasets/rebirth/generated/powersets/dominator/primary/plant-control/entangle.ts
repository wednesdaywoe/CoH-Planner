...
export const Entangle: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Smashing",0.196,1,9.2,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,2,1,null,null,null,null,null,null,"enttype target> player eq"],
    ["Damage","Lethal",0.196,1,9.2,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,2,1,null,null,null,null,null,null,"enttype target> player eq"],
