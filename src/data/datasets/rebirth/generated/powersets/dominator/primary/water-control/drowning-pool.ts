...
export const DrowningPool: Power = {
  ...
  "atoms": [
    ...
    ["Defense","All",2.5,1,15,"Ranged_Debuff_Def","Cur","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,"Temporary_Powers.Temporary_Powers.Water_Control_Drowning target.ownPower?"]
  ],
  "conditionalEffects": [
    {
      "id": "domination",
