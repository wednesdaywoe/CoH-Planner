...
export const Roots: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Smashing",0.091098,1,5.2,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,2,1,null,null,null,null,null,null,"enttype target> player eq"],
    ["Damage","Lethal",0.091098,1,5.2,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,2,1,null,null,null,null,null,null,"enttype target> player eq"],
