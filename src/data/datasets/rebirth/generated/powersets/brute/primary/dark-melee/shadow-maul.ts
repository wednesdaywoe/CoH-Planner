...
export const ShadowMaul: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Smashing",0.485048,1,2,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.625,1,null,null,null,null,null,null,"enttype target> player eq"],
    ["Damage","Negative",0.485048,1,2,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.625,1,null,null,null,null,null,null,"enttype target> player eq"],
