...
export const FollowThrough: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Stunned",4,3,0,"Melee_Stun","Cur","Duration","Target","PvP",true,"Stack",2,null,null,0.33000001311302185,null,null,null,null,null,null,"enttype target> player eq"],
    ...
    ["Damage","Smashing",2.028781,1,0,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> player eq"]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
