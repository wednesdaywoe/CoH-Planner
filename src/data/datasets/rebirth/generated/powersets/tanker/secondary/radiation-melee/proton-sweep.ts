...
export const ProtonSweep: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Energy",0.130516,1,3.1,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,1,1,null,null,null,null,null,null,"enttype target> player eq"],
    ["Damage","Toxic",0.391548,1,3.1,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,1,1,null,null,null,null,null,null,"enttype target> player eq"],
