...
export const AoEBridge: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Taunt",6,4,0,"Melee_Ones","Abs","Duration","Target","PvP",true,"Stack",2,null,null,0.14399999380111694,null,null,null,null,null,null,["enttype","target>","player","eq"],true,null,null,null,null,null,null,0.14],
    ...
    ["Damage","Fire",0.2565,1,0,"Melee_Damage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,0,null,null,null,null,null,null,["kDD_BonusAoEMode_2","source.Mode?"],true,null,null,null,null,null,null,0]
  ],
  "conditionalEffects": [
    {
      "id": "dd_debuffmode_2",
