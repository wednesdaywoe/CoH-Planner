...
export const AoEBridge: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Fire",0.2565,1,0,"Melee_Damage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,"kDD_BonusAoEMode_2 source.Mode?",true]
  ],
  "conditionalEffects": [
    {
      "id": "dd_debuffmode_2",
