...
export const ArcofDestruction: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Smashing",2.798631,1,0,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true],
    ...
    ["Mez","Taunt",6,4,0,"Melee_Ones","Abs","Duration","Target","PvP",true,"Stack",2,null,null,0.2800000011920929,null,null,null,null,null,null,"enttype target> player eq",true,null,null,null,null,null,null,0.28]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
