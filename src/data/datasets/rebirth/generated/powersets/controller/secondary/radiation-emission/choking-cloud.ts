...
export const ChokingCloud: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Held",4,2,0,"Ranged_Ones","Cur","Duration","Target","PvP",true,"Replace",2,null,null,0.800000011920929,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
