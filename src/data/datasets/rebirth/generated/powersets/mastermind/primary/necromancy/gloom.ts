...
export const Gloom: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Negative",0.281053,1,3.6,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.5,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ]
};
