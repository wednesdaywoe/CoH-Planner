...
export const HailofBullets: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Fire",0.1362,1,3.5,"Ranged_Damage","Abs","Magnitude","Target","PvE",true,"Stack",2,null,0.30000001192092896,0,null,null,null,null,null,null,"enttype target> critter eq"],
    ["Damage","Fire",0.2,1,4.1,"Ranged_Damage","Abs","Magnitude","Target","Any",true,"Stack",2,null,1,0],
    ["Damage","Cold",0.1362,1,3.5,"Ranged_Damage","Abs","Magnitude","Target","PvE",true,"Stack",2,null,0.30000001192092896,0,null,null,null,null,null,null,"enttype target> critter eq"],
    ...
    ["Damage","Toxic",0.1362,1,3.5,"Ranged_Damage","Abs","Magnitude","Target","PvE",true,"Stack",2,null,0.30000001192092896,0,null,null,null,null,null,null,"enttype target> critter eq"],
    ["DamageBuff","Lethal",2,1,8,"Ranged_Debuff_Dam","Str","Magnitude","Target","Any",true,"Replace",2,null,null,0,null,true],
    ["DamageBuff","Smashing",2,1,8,"Ranged_Debuff_Dam","Str","Magnitude","Target","Any",true,"Replace",2,null,null,0,null,true],
    ["DamageBuff","Fire",2,1,8,"Ranged_Debuff_Dam","Str","Magnitude","Target","Any",true,"Replace",2,null,null,0,null,true],
    ["DamageBuff","Cold",2,1,8,"Ranged_Debuff_Dam","Str","Magnitude","Target","Any",true,"Replace",2,null,null,0,null,true],
    ["DamageBuff","Energy",2,1,8,"Ranged_Debuff_Dam","Str","Magnitude","Target","Any",true,"Replace",2,null,null,0,null,true],
    ["DamageBuff","Negative",2,1,8,"Ranged_Debuff_Dam","Str","Magnitude","Target","Any",true,"Replace",2,null,null,0,null,true],
    ["DamageBuff","Toxic",2,1,8,"Ranged_Debuff_Dam","Str","Magnitude","Target","Any",true,"Replace",2,null,null,0,null,true],
    ["DamageBuff","Psionic",2,1,8,"Ranged_Debuff_Dam","Str","Magnitude","Target","Any",true,"Replace",2,null,null,0,null,true],
    ...
    ["Damage","Fire",0.083,1,3.5,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.30000001192092896,0,null,null,null,null,null,null,"enttype target> player eq",true],
    ["Damage","Cold",0.083,1,3.5,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.30000001192092896,0,null,null,null,null,null,null,"enttype target> player eq",true],
    ["Damage","Toxic",0.083,1,3.5,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.30000001192092896,0,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
