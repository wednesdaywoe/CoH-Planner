...
export const BulletRain: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Fire",0.086599,1,1.1,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.5,0,null,null,null,null,null,null,"enttype target> player eq",true],
    ["Damage","Cold",0.086599,1,1.1,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.5,0,null,null,null,null,null,null,"enttype target> player eq",true],
    ["Damage","Toxic",0.086599,1,1.1,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.5,0,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
