...
export const EmptyClips: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Fire",0.084063,1,1.6,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.5,0,null,null,null,null,null,null,"enttype target> player eq",true],
    ["Damage","Cold",0.084063,1,1.6,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.5,0,null,null,null,null,null,null,"enttype target> player eq",true],
    ["Damage","Toxic",0.084063,1,1.6,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.5,0,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
