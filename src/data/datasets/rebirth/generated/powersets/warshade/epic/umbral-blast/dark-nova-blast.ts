...
export const DarkNovaBlast: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Negative",2.322647,1,0,"Ranged_SSDamage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,["enttype","target>","player","eq"],true,null,null,null,null,null,null,null,null,"SSDamage"]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
