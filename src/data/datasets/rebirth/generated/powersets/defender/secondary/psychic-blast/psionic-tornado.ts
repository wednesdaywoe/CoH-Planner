...
export const PsionicTornado: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Psionic",0.223088,1,4.1,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,1,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
