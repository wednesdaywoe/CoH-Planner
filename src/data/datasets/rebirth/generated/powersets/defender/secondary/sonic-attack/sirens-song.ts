...
export const SirensSong: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Energy",0.816327,1,0,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ]
};
