...
export const EMPArrow: Power = {
  ...
  "atoms": [
    ...
    ["Endurance",null,-0.11,1,0,"Ranged_Ones","Cur","Magnitude","Target","PvE",true,"Stack",2,null,null,1,null,null,null,null,null,null,["enttype","target>","critter","eq","Temporary_Powers.Temporary_Powers.AcidArrow_AcidBurn","target.ownPower?","&&"],true],
