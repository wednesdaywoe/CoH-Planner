...
export const Burst: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Lethal",0.475343,1,0.7,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.30000001192092896,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ]
};
