...
export const CrowdControl: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Smashing",1.743037,1,0,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> player eq"],
    ["Damage","Smashing",1.162606,1,0,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,null,0.5,null,null,null,null,null,null,"kMeter source> 0 > enttype target> player eq &&"],
    ...
    ["Damage","Smashing",1.073333,1,0,"Melee_Damage","Abs","Magnitude","Target","PvE",true,"Stack",2,null,null,0.5,null,null,null,null,null,null,"kMeter source> 0 > enttype target> critter eq &&"]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
