...
export const Pummel: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Smashing",1.753881,1,0,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> player eq"],
    ["Damage","Smashing",1.169839,1,0,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,"kMeter source> 0 > enttype target> player eq &&"],
    ["Mez","Stunned",2,3,0,"Melee_Ones","Cur","Duration","Target","PvP",true,"Stack",2,null,null,0.6600000262260437,null,null,null,null,null,null,"enttype target> player eq"]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
