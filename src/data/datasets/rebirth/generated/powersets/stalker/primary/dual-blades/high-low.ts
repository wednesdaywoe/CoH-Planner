...
export const HighLow: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Lethal",2.21,1,0,"Melee_Damage","Abs","Expression","Target","PvE",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> critter eq kMeter source> .9 < &&",true],
