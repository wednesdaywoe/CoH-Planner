...
export const PoisonDart: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Lethal",1.633169,1,0,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ]
};
