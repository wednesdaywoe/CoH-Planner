...
export const BulletRain: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Knockback",2,1,0,"Ranged_Ones","Cur","Magnitude","Target","PvE",true,"Stack",2,null,null,0.5,null,null,null,null,null,null,["enttype","target>","critter","eq"],null,null,null,null,null,null,null,0.5],
    ...
    ["Mez","Knockback",2,1,0,"Ranged_Ones","Cur","Magnitude","Target","PvP",true,"Stack",2,null,null,0.5,null,null,null,null,null,null,["enttype","target>","player","eq"],true,null,null,null,null,null,null,0.5],
    ["Damage","Fire",0.095259,1,1.1,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.5,0,null,null,null,null,null,null,["enttype","target>","player","eq"],true,null,null,null,null,null,null,0],
    ["Damage","Cold",0.095259,1,1.1,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.5,0,null,null,null,null,null,null,["enttype","target>","player","eq"],true,null,null,null,null,null,null,0],
    ["Damage","Toxic",0.095259,1,1.1,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.5,0,null,null,null,null,null,null,["enttype","target>","player","eq"],true,null,null,null,null,null,null,0]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
