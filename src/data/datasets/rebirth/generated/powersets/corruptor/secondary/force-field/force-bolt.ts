...
export const ForceBolt: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Smashing",1,1,0,"Ranged_Damage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,["kHitPoints%","target>","10","-","100","*","50","10","-","/","0","100","minmax","rand","100","*","<","cur.kUntouchable","target>","0","<=","&&"],true,null,null,null,null,null,null,null,null,"Damage"],
    ...
    ["Meta",null,1,1,0,"Ranged_Ones","Abs","Magnitude","Target","PvP",false,"Stack",2,null,null,0,null,true,null,null,null,null,["enttype","target>","player","eq","cur.kUntouchable","target>","0","<=","&&"],true,null,null,null,null,null,null,0,null,"Ones",null,"drop_toggles"],
    ["Mez","Stunned",2,2,0,"Ranged_Ones","Cur","Duration","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,["enttype","target>","player","eq","cur.kUntouchable","target>","0","<=","&&"],true,null,null,null,null,null,null,null,null,"Ones"]
  ]
};
