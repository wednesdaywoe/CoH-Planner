...
export const EntanglingArrow: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Immobilized",2,1,0,"Ranged_Ones","Cur","Duration","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,["enttype","target>","player","eq","Temporary_Powers.Temporary_Powers.DisruptionArrow_Disrupted","target.ownPower?","&&"],true]
  ],
  "conditionalEffects": [
    {
