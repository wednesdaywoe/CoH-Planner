...
import { overrides } from '@/data/datasets/thunderspy/overrides/powersets/tanker/primary/nature-armor/geomancy';

export const Geomancy: Power = withOverrides(base, overrides);
