 ...
 * Archetype: defender
 * Category: secondary
 * Source: defender_ranged/kinetic_assault
 */
...
import { SpeedSiphon as SpeedSiphon } from './speed-siphon';
import { MassDriver as MassDriver } from './mass-driver';

export const powerset: Powerset = {
  id: 'defender/kinetic-assault',
  setPath: 'Defender_Ranged.Kinetic_Assault',
