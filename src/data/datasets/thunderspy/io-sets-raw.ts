/**
 * Thunderspy IO Set data — extracted from the committed bin-crawler export.
 *
 * Auto-generated by `scripts/extract-rebirth-io-sets-v2.py --dataset thunderspy`.
 * Do not hand-edit.
 *
 * Source: exported_powers/thunderspy/ (produced by `bin_crawler.export_powers`)
