...
export const BattleAgility: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,100,1,120,"Melee_Ones","Res","Magnitude","Self","Any",true,"No",null,null,null,1,null,null,null,null,null,null,"isPVPMap? !"],
    ["Unmapped",null,0.5,1,120,"Melee_Res_Boolean","Res","Magnitude","Self","Any",true,"No",null,null,null,1],
    ...
    ["Unmapped",null,-10,1,120,"Melee_Ones","Cur","Magnitude","Self","Any",true,"No",null,null,null,1,null,null,null,null,null,null,"isPVPMap?",true]
  ]
};
