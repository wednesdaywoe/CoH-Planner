...
export const Screech: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,-2,1,12,"Ranged_Res_Dmg","Res","Magnitude","Target","Any",true,"No",null,null,null,1],
    ["Unmapped",null,0.2,1,0,"Ranged_Damage","Abs","Magnitude","Target","PvE",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> critter eq kHitPoints% target> 15 < &&",true],
    ["Unmapped",null,0.2,1,0,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq kHitPoints% target> 15 < &&",true],
