...
export const FullAuto: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.439299,1,3.3,"Ranged_Damage","Cur","Magnitude","Unspecified","PvP",true,"No",null,null,0.20000000298023224,1,null,null,null,null,null,null,"enttype target> player eq"],
    ["Unmapped",null,0.162,1,3.3,"Ranged_Damage","Cur","Magnitude","Unspecified","PvE",true,"No",null,null,0.20000000298023224,1,null,null,null,null,null,null,"kHitPoints% target> 10 - 100 * 50 10 - / 0 100 minmax rand 100 * < enttype target> critter eq &&"],
    ["Unmapped",null,0.439299,1,3.3,"Ranged_Damage","Cur","Magnitude","Unspecified","PvP",true,"No",null,null,0.20000000298023224,1,null,null,null,null,null,null,"kHitPoints% target> 10 - 100 * 50 10 - / 0 100 minmax rand 100 * < enttype target> player eq &&"]
  ]
};
