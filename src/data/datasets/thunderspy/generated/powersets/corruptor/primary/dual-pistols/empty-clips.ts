...
export const EmptyClips: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.1775,1,1.6,"Ranged_Damage","Cur","Magnitude","Unspecified","PvP",true,"No",null,null,0.5,1,null,null,null,null,null,null,"enttype target> player eq"],
    ["Unmapped",null,0.26,1,1.6,"Ranged_Damage","Cur","Magnitude","Unspecified","PvE",true,"No",null,null,0.5,1,null,null,null,null,null,null,"kHitPoints% target> 10 - 100 * 50 10 - / 0 100 minmax rand 100 * < enttype target> critter eq &&"],
    ["Unmapped",null,0.308231,1,1.6,"Ranged_Damage","Cur","Magnitude","Unspecified","PvP",true,"No",null,null,0.5,1,null,null,null,null,null,null,"kHitPoints% target> 10 - 100 * 50 10 - / 0 100 minmax rand 100 * < enttype target> player eq &&"]
  ],
  "conditionalEffects": [
    {
      "id": "lethalammo",
