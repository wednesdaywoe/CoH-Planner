...
export const Deceive: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Confused",30,1,0,"Ranged_Immobilize","Cur","Magnitude","Unspecified","PvE",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> critter eq kStealth source> 0.5 > &&"],
    ...
    ["Mez","Confused",4,1,0,"Ranged_Immobilize","Cur","Magnitude","Unspecified","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq kStealth source> 0.5 > &&"]
  ],
  "conditionalEffects": [
    {
      "id": "domination",
