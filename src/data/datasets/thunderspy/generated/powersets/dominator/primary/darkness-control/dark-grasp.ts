...
export const DarkGrasp: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Negative",2.6446,1,0,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "conditionalEffects": [
    {
      "id": "domination",
