...
export const RingofFire: Power = {
  ...
  "atoms": [
    ["Unmapped",null,0.22,1,9.2,"Ranged_Damage","Abs","Magnitude","Target","PvE",true,"No",null,null,2,1,null,null,null,null,null,null,"enttype target> critter eq"],
    ...
    ["Unmapped",null,0.38612,1,9.2,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"No",null,null,2,1,null,null,null,null,null,null,"enttype target> player eq",true],
