...
export const Microburst: Power = {
  ...
  "atoms": [
    ["Damage","Smashing",0.2,1,0,"Ranged_Damage","Abs","Expression","Target","PvE",true,"Stack",2,null,null,1,null,null,null,null,null,null,["enttype","target>","critter","eq"],null,null,null,null,null,["@Scale","0.55","Temporary_Powers.Temporary_Powers.Wind_Control_Pressure","source.ownPowerNum?","*","+","@Value","*","@Effectiveness","*","@Strength","*"]],
    ...
    ["Damage","Smashing",0.2,1,0,"Ranged_Damage","Abs","Expression","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,["enttype","target>","player","eq"],true,null,null,null,null,["@Scale","0.55","Temporary_Powers.Temporary_Powers.Wind_Control_Pressure","source.ownPowerNum?","*","+","@Value","*","@Effectiveness","*","@Strength","*"]],
