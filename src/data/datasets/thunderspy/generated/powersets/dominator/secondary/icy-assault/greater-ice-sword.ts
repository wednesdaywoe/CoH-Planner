...
export const GreaterIceSword: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.95,1,0,"Melee_Damage","Unspecified","Magnitude","Unspecified","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true],
