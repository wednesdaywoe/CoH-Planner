...
export const AtomSmasher: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Energy",1.55,1,0,"Melee_Damage","Abs","Magnitude","Target","PvE",true,"Stack",2,null,null,0.5,null,null,null,null,null,null,"kMeter source> 0 > enttype target> critter eq &&",true]
  ],
  "specialEffects": [
    {
      "kind": "grant",
