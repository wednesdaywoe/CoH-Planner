...
export const InitialStrike: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Smashing",1.095542,0.20000000298023224,0,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,"kMeter source> .9 < kHeld target> 0 > kSleep target> 0 > || && enttype target> player eq &&",true],
