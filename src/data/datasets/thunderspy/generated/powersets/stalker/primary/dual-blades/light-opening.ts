...
export const LightOpening: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,1.258859,0.20000000298023224,0,"Melee_Damage","Unspecified","Magnitude","Unspecified","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"kMeter source> .9 < kHeld target> 0 > kSleep target> 0 > || && enttype target> player eq &&",true],
    ["Unmapped",null,0.629429,1,0.5,"Melee_Damage","Unspecified","Magnitude","Unspecified","PvP",true,"No",null,null,0.33000001311302185,1,null,null,null,null,null,null,"enttype target> player eq",true],
    ["Unmapped",null,1.258859,1,0,"Melee_Damage","Unspecified","Magnitude","Unspecified","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"kMeter source> 0 > enttype target> player eq &&",true],
