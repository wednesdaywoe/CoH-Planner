...
export const BrightNova: Power = {
  ...
  "atoms": [
    ["Unmapped",null,4,1,1.5,"Melee_Ones","Cur","Magnitude","Self","Any",true,"No",null,null,null,1],
    ["Movement","Fly",1.5,1,1.5,"Melee_SpeedFlying","Cur","Magnitude","Self","Any",true,"No",null,null,null,1],
    ["Movement","Control",2,1,1.5,"Melee_Control","Cur","Magnitude","Self","Any",true,"No",null,null,null,1],
    ["Movement","Friction",2,1,1.5,"Melee_Friction","Cur","Magnitude","Self","Any",true,"No",null,null,null,1],
    ["ToHit",null,1,1,1.5,"Melee_Buff_ToHit","Cur","Magnitude","Self","Any",true,"No",null,null,null,1],
    ["Unmapped",null,5,1,1.5,"Melee_Buff_Dmg","Str","Magnitude","Self","Any",true,"No",null,null,null,1]
  ]
};
