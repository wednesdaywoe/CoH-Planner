...
export const GleamingBlast: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Knockback",1,1,0,"Ranged_Knockback","Cur","Magnitude","Target","PvP",true,"Stack",2,null,null,0.10000000149011612,null,true,null,null,null,null,"enttype target> player eq",true]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
