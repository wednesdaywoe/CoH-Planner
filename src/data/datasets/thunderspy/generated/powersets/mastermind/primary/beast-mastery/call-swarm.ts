...
export const CallSwarm: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.368199,1,1.5,"Ranged_Damage","Cur","Magnitude","Unspecified","PvP",true,"No",null,null,0.375,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ]
};
