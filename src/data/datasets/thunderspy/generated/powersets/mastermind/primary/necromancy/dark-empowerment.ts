...
export const DarkEmpowerment: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,1,1,0,"Ranged_Ones","Abs","Magnitude","Target","Any",true,"No",null,null,null,1,null,null,null,null,null,null,"MastermindPets_Skeletal_Warrior target.VillainName> kRage target> .5 > &&",true],
