...
export const EmptyClips: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.461317,1,0.7,"Ranged_Damage","Cur","Magnitude","Unspecified","PvP",true,"No",null,null,0.30000001192092896,1,null,null,null,null,null,null,"enttype target> player eq",true],
    ["Mez","Knockback",0.64,0.10000000149011612,0,"Ranged_Knockback","Cur","Magnitude","Unspecified","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ]
};
