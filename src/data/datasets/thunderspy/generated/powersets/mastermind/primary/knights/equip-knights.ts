...
export const EquipKnights: Power = {
  ...
  "atoms": [
    ...
    ["Meta",null,1,0,0,"Ranged_Ones","Abs","Magnitude","Target","Any",false,"Ignore",2,null,null,1,null,true,null,null,null,null,"costume target> Mastermind_Knight_Minion_01_01 eq kMastermind_Upgrade_2 target.mode? && group target> MastermindPets eq &&",true],
    ...
    ["Meta",null,1,0,0,"Ranged_Ones","Abs","Magnitude","Target","Any",false,"Ignore",2,null,null,1,null,true,null,null,null,null,"costume target> Mastermind_Knight_Minion_02_01 eq kMastermind_Upgrade_2 target.mode? && group target> MastermindPets eq &&",true],
    ...
    ["Meta",null,1,0,0,"Ranged_Ones","Abs","Magnitude","Target","Any",false,"Ignore",2,null,null,1,null,true,null,null,null,null,"costume target> Mastermind_Knight_Minion_03_01 eq kMastermind_Upgrade_2 target.mode? && group target> MastermindPets eq &&",true],
    ...
    ["GrantPower",null,1,1,0,"Ranged_Ones","Abs","Magnitude","Target","Any",false,"Ignore",2,null,null,1,null,true,null,null,null,null,"costume target> Mastermind_Knight_Lieutenant_01_01 eq kMastermind_Upgrade_2 target.mode? &&",true],
    ...
    ["GrantPower",null,1,1,0,"Ranged_Ones","Abs","Magnitude","Target","Any",false,"Ignore",2,null,null,1,null,true,null,null,null,null,"costume target> Mastermind_Knight_Lieutenant_02_01 eq kMastermind_Upgrade_2 target.mode? &&",true],
    ...
    ["Meta",null,1,0,0,"Ranged_Ones","Abs","Magnitude","Target","Any",false,"Ignore",2,null,null,1,null,true,null,null,null,null,"costume target> Mastermind_Knight_Boss_01_01 eq kMastermind_Upgrade_2 target.mode? &&",true]
  ],
