...
export const DualWield: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Knockback",0.64,1,0,"Ranged_Knockback","Cur","Magnitude","Target","PvP",true,"Stack",2,null,null,0.25,null,true,null,null,null,null,"enttype target> player eq",true]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
