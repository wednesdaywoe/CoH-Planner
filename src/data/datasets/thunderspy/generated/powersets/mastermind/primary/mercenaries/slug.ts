...
export const Slug: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Knockback",0.75,0.25,0,"Ranged_Knockback","Cur","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,true,null,null,null,null,"enttype target> player eq",true]
  ],
  "damageTypes": [
    "Lethal"
  ]
