...
export const DisciplineAllies: Power = {
  ...
  "atoms": [
    ...
    ["Regeneration",null,2.5,1,30,"Ranged_Ones","Cur","Magnitude","Target","PvE",false,"Replace",2,null,null,1,null,null,null,null,null,null,["kHitPoints%","target>","1","-","30","<","enttype","target>","critter","eq","&&"],true,null,null,null,null,null,null,null,null,"Ones"],
    ["Regeneration",null,2.5,1,30,"Ranged_Ones","Cur","Magnitude","Target","PvP",false,"Replace",2,null,null,1,null,null,null,null,null,null,["kHitPoints%","target>","1","-","30","<","enttype","target>","player","eq","&&"],true,null,null,null,null,null,null,null,null,"Ones"]
  ],
  "conditionalEffects": [
    {
      "id": "conditional",
