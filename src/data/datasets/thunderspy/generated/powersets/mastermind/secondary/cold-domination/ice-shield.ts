...
export const IceShield: Power = {
  ...
  "atoms": [
    ["Defense","Melee",1.5,1,240,"Ranged_Buff_Def","Cur","Magnitude","Target","Any",true,"No",null,null,null,1],
    ...
    ["Defense","Lethal",1.5,1,240,"Ranged_Buff_Def","Cur","Magnitude","Target","Any",true,"No",null,null,null,1],
    ...
    ["Defense","Melee",0.75,1,240,"Ranged_Buff_Def","Cur","Magnitude","Target","Any",true,"No",null,null,null,1],
    ["Defense","Ranged",0.75,1,240,"Ranged_Buff_Def","Cur","Magnitude","Target","Any",true,"No",null,null,null,1],
    ["Defense","AoE",0.75,1,240,"Ranged_Buff_Def","Cur","Magnitude","Target","Any",true,"No",null,null,null,1],
    ["Defense","Smashing",0.75,1,240,"Ranged_Buff_Def","Cur","Magnitude","Target","Any",true,"No",null,null,null,1],
    ["Defense","Lethal",0.75,1,240,"Ranged_Buff_Def","Cur","Magnitude","Target","Any",true,"No",null,null,null,1],
    ["Defense","Energy",0.75,1,240,"Ranged_Buff_Def","Cur","Magnitude","Target","Any",true,"No",null,null,null,1],
    ["Defense","Negative",0.75,1,240,"Ranged_Buff_Def","Cur","Magnitude","Target","Any",true,"No",null,null,null,1]
  ]
};
