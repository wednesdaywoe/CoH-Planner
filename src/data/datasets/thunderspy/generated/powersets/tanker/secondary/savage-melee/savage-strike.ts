...
export const SavageStrike: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,1.344067,1,0,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true],
    ...
    ["Unmapped",null,6,0.07500000298023224,0,"Melee_Ones","Abs","Duration","Target","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "conditionalEffects": [
    {
      "id": "blooddrink",
