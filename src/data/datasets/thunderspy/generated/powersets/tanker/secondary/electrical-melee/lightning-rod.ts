...
export const LightningRod: Power = {
  ...
  "atoms": [
    ...
    ["EntCreate",null,-1,0,4,"Ranged_Ones","Cur","Magnitude","Target","Any",false,"Replace",2,null,null,1,null,true],
    ["EntCreate",null,-1,1,4,"Ranged_Ones","Unspecified","Magnitude","Unspecified","Any",true,"No",null,null,null,1]
  ],
  "damageTypes": [
    "Energy"
  ]
