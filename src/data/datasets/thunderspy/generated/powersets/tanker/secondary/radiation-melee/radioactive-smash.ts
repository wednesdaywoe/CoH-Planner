...
export const RadioactiveSmash: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.548405,1,0,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true],
    ...
    ["Unmapped",null,6,0.14800000190734863,0,"Melee_Ones","Abs","Duration","Target","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "damageTypes": [
    "Energy",
    "Smashing"
