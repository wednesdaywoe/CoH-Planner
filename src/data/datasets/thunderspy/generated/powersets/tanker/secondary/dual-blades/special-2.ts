...
export const Special2: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Fire",0.09,1,4.1,"Melee_Damage","Abs","Magnitude","Target","Any",true,"Stack",2,null,1,1,null,null,null,null,null,null,["kDD_BonusDoTMode_2","Source.Mode?"],true,null,null,null,null,null,null,0,null,"FieryEmbrace"]
  ],
  "conditionalEffects": [
    {
      "id": "comboblade3",
