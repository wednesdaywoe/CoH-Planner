...
export const BreathofFire: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.966932,1,0.6,"Melee_Damage","Cur","Magnitude","Unspecified","PvP",true,"No",null,null,0.5,1,null,null,null,null,null,null,"enttype target> player eq"],
    ...
    ["Unmapped",null,6,0.13699999451637268,0,"Melee_Ones","Cur","Magnitude","Unspecified","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq"]
  ]
};
