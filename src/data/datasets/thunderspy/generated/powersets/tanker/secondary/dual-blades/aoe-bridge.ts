...
export const AoEBridge: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,6,0.14399999380111694,0,"Melee_Ones","Unspecified","Magnitude","Unspecified","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true],
    ...
    ["Unmapped",null,0.2565,0,0,"Melee_Damage","Unspecified","Magnitude","Unspecified","Any",true,"No",null,null,null,1,null,null,null,null,null,null,"kDD_BonusAoEMode_2 Source.Mode?",true]
  ],
  "conditionalEffects": [
    {
      "id": "comboblade3",
