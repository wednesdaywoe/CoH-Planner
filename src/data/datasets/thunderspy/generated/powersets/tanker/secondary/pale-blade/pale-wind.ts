...
export const PaleWind: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Terrorized",0.5,3,0,"Melee_Fear","Cur","Duration","Target","PvE",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> critter eq"],
    ["Unmapped",null,0.1,1,6,"Melee_Damage","Abs","Magnitude","Target","Any",true,"No",null,null,0.5,1,null,null,null,null,null,null,"Temporary_Powers.Temporary_Powers.Pale_Enemy_Fester target.ownPower?",true],
    ["Unmapped",null,0.1,1,6,"Melee_Damage","Abs","Magnitude","Target","Any",true,"No",null,null,0.5,1,null,null,null,null,null,null,"Temporary_Powers.Temporary_Powers.Pale_Self_Buff_Plaguebearer source.ownPower?",true],
