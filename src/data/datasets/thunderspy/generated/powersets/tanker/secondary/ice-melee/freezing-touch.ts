...
export const FreezingTouch: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Taunt",6,0.2919999957084656,0,"Melee_Ones","Abs","Duration","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "damageTypes": [
    "Cold"
  ]
