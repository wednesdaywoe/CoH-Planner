...
export const ProtonSweep: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Energy",0.130516,1,1.5,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.5,1,null,null,null,null,null,null,"enttype target> player eq",true],
    ["Damage","Toxic",0.391548,1,1.5,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.5,1,null,null,null,null,null,null,"enttype target> player eq",true],
