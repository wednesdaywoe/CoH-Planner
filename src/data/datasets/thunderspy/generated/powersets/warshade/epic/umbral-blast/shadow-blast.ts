...
export const ShadowBlast: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Knockback",1,0.10000000149011612,0,"Ranged_Knockback","Cur","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "damageTypes": [
    "Negative"
  ]
