...
export const WebGrenade: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Immobilized",0.3,3,0,"Ranged_Ones","Unspecified","Magnitude","Unspecified","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ]
};
