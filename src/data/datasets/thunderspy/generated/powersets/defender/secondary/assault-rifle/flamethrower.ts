...
export const Flamethrower: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.232041,1,3.55,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"No",null,null,0.5,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "damageTypes": [
    "Fire"
  ]
