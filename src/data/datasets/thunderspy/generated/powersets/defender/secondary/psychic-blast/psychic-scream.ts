...
export const PsychicScream: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Psionic",1.565727,1,0,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,["enttype","target>","player","eq"],true,null,null,null,null,null,null,null,null,"Damage"]
  ],
  "damageTypes": [
    "Psionic"
  ]
