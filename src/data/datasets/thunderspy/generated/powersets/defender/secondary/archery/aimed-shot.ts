...
export const AimedShot: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Lethal",1.966357,1,0,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "damageTypes": [
    "Lethal"
  ]
