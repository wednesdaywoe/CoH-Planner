...
export const NightFall: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Negative",0.136243,1,2.8,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.30000001192092896,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "damageTypes": [
    "Negative"
  ]
