...
export const MassDriver: Power = {
  ...
  "atoms": [
    ...
    ["RechargePower",null,1,0.14000000059604645,0,"Ranged_Ones","Cur","Magnitude","Self","Any",false,"Ignore",2,null,null,1,null,true,null,null,null,null,"Temporary_Powers.Temporary_Powers.Kinetic_Assault_Impulse source.ownPowerNum? 5 >= Defender_Ranged.Kinetic_Assault.Coalescence source.ownPower? &&",true]
  ],
  "conditionalEffects": [
    {
