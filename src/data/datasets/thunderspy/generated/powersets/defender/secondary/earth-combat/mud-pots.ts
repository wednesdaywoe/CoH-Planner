...
export const MudPots: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Immobilized",2.25,2,0,"Melee_Ones","Cur","Magnitude","Unspecified","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ]
};
