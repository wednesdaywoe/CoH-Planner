...
export const GreaterFireSword: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.39,1,2.1,"Melee_Damage","Abs","Magnitude","Target","Any",true,"No",null,null,1,1],
    ["Unmapped",null,0.985,1,0,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
