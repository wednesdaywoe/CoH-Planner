...
export const FistfulofArrows: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Lethal",1.111928,1,0,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,["enttype","target>","player","eq"],true,null,null,null,null,null,null,null,null,"Damage"]
  ],
  "damageTypes": [
    "Lethal"
  ]
