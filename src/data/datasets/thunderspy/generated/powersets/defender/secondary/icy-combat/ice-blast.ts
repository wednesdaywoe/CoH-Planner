...
export const IceBlast: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Cold",1.768785,1,0,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,["enttype","target>","player","eq"],true,null,null,null,null,null,null,null,null,"Damage"]
  ],
  "requires": [
    "Defender_Ranged.Ice_Blast.Ice_Sword",
    "!"
  ],
  "damageTypes": [
    "Cold",
