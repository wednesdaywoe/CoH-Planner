...
export const Suppression: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Energy",0.176955,1,3.1,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"Stack",2,null,0.6000000238418579,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "damageTypes": [
    "Energy"
  ]
