...
export const Vacuum: Power = {
  ...
  "atoms": [
    ...
    ["Meta",null,1,108,0,"Ranged_Ones","Cur","Expression","Self","Any",false,"Ignore",2,null,null,1,null,true,null,null,null,null,"kCloudedSkies Source.Mode? ! entref target.owner> entref source> eq &&",true],
    ["Meta",null,1,109,239,"Ranged_Ones","Cur","Magnitude","Self","Any",false,"Ignore",2,null,null,1,null,true,null,null,null,null,"entref target.owner> entref source> eq",true],
