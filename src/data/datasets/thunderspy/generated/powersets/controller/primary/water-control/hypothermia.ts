...
export const Hypothermia: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Sleep",3,1,15.1,"Ranged_Sleep","Cur","Duration","Target","PvE",true,"Stack",2,null,3,1,null,null,null,null,null,null,"enttype target> critter eq Temporary_Powers.Temporary_Powers.Water_Control_Drowning target.ownPower? ! &&",null,null,null,null,null,null,null,0.3],
    ...
    ["Mez","Sleep",3,1,15.1,"Ranged_Sleep","Cur","Duration","Target","PvE",true,"Stack",2,null,3,1,null,null,null,null,null,null,"enttype target> critter eq Temporary_Powers.Temporary_Powers.Water_Control_Drowning target.ownPower? &&",true,null,null,null,null,null,null,0.38],
