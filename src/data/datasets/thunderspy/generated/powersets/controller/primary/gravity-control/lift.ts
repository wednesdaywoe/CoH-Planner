...
export const Lift: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.33,1,0,"Ranged_Damage","Abs","Magnitude","Target","Any",true,"No",null,null,null,1,null,null,null,null,null,null,"now GravityDistortion target.TokenTime> - 12 <",true],
    ...
    ["Unmapped",null,1.32,1,0,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq kImmobilized target> 0 > kHeld target> 0 > || kSleep target> 0 > || kStunned target> 0 > || &&",true]
  ],
  "damageTypes": [
    "Smashing"
  ]
