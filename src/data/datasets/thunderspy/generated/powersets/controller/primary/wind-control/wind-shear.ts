...
export const WindShear: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,-1,1,2.1,"Melee_SpeedRunning","Unspecified","Magnitude","Unspecified","PvE",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> critter eq"],
