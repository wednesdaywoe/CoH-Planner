...
export const BlackHole: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.3,1,0.6,"Ranged_Ones","Unspecified","Magnitude","Unspecified","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ]
};
