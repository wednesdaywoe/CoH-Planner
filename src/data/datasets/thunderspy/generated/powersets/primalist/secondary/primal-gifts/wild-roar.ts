...
export const WildRoar: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Terrorized",2,3,0,"Melee_Ones","Cur","Duration","Target","PvP",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> player eq kHunterMode Source.Mode? &&",true]
  ],
  "conditionalEffects": [
    {
      "id": "prowlermode",
