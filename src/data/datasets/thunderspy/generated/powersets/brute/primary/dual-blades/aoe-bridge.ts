...
export const AoEBridge: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Fire",0.2565,0,0,"Melee_Damage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,"Temporary_Powers.Temporary_Powers.ComboBlade3 source.ownPower?",true]
  ],
  "conditionalEffects": [
    {
      "id": "comboblade3",
