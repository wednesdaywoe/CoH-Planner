...
export const FollowThrough: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Stunned",4,3,0,"Melee_Stun","Cur","Duration","Target","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true],
    ...
    ["Unmapped",null,2.028781,1,0,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "modesRequired": [
    "FastMode"
  ],
