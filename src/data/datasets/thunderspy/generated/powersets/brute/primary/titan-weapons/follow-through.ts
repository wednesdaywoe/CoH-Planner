...
export const FollowThrough: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Stunned",4,3,0,"Melee_Stun","Cur","Magnitude","Unspecified","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq"],
    ...
    ["Unmapped",null,2.028781,1,0,"Melee_Damage","Cur","Magnitude","Unspecified","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq"]
  ],
  "modesRequired": [
    "FastMode"
  ]
