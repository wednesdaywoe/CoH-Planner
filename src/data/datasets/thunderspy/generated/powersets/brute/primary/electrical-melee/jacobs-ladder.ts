...
export const JacobsLadder: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Sleep",6,2,0,"Melee_Sleep","Cur","Duration","Target","Any",true,"No",null,null,null,1],
    ["Mez","Sleep",2,2,0,"Melee_Ones","Cur","Duration","Target","Any",true,"No",null,null,null,1],
    ...
    ["Unmapped",null,2.554912,1,0,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true],
