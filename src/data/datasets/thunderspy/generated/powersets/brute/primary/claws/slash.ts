...
export const Slash: Power = {
  ...
  "atoms": [
    ["Unmapped",null,0.74,1,0,"Melee_Damage","Abs","Magnitude","Target","PvE",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> critter eq"],
    ...
    ["Unmapped",null,0.333,0,0,"Melee_Damage","Abs","Magnitude","Target","Any",true,"No",null,null,null,1],
    ["Unmapped",null,0.333,0,0,"Melee_Damage","Abs","Magnitude","Target","Any",true,"No",null,null,null,1],
    ["Unmapped",null,1.073225,1,0,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true],
