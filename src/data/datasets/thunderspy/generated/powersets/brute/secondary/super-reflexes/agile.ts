...
export const Agile: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Taunt",2.25,1,0,"Melee_InherentTaunt","Abs","Duration","Target","PvE",true,"Stack",2,null,null,1,null,true,null,null,null,null,"Raid target.HasTag? ! enttype target> critter eq &&"],
    ...
    ["Mez","Taunt",2.25,1,0,"Melee_InherentTaunt","Abs","Duration","Target","Any",true,"Stack",2,null,null,1,null,true,null,null,null,null,"Raid target.HasTag? @ToHitRoll 0.2 + @ToHit < &&",true]
  ],
  "damageTypes": [
    "Energy"
  ]
