...
export const Agile: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,2.25,1,0,"Melee_InherentTaunt","Abs","Duration","Target","PvE",true,"No",null,null,null,1,null,null,null,null,null,null,"Raid target.HasTag? ! enttype target> critter eq &&"],
    ...
    ["Unmapped",null,2.25,1,0,"Melee_InherentTaunt","Abs","Duration","Target","Any",true,"No",null,null,null,1,null,null,null,null,null,null,"Raid target.HasTag? @ToHitRoll 0.2 + @ToHit < &&",true]
  ],
  "damageTypes": [
    "Energy"
  ]
