...
export const CloakofFear: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Terrorized",3.3,3,0,"Melee_Fear","Unspecified","Magnitude","Unspecified","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ]
};
