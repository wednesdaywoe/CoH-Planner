...
export const Consume: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.05,1,0,"Melee_Ones","Unspecified","Magnitude","Unspecified","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"Raid target.HasTag? enttype target> player eq || @ToHitRoll @ToHit < @ForceHit || &&",true],
