...
export const TenebrousTentacles: Power = {
  ...
  "atoms": [
    ["Unmapped",null,0.07235,1,7.1,"Ranged_Damage","Abs","Magnitude","Target","PvE",true,"No",null,null,1,1,null,null,null,null,null,null,"enttype target> critter eq"],
    ...
    ["Unmapped",null,0.048,1,9.17,"Ranged_Ones","Str","Magnitude","Self","Any",true,"No",null,null,null,1],
    ["Unmapped",null,0.026201,1,7.1,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"No",null,null,1,1,null,null,null,null,null,null,"enttype target> player eq",true],
