...
export const Shout: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.176,1,10.17,"Ranged_Ones","Str","Magnitude","Self","Any",true,"No",null,null,null,1],
    ["Unmapped",null,3.330889,1,0,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "damageTypes": [
    "Energy",
    "Smashing"
