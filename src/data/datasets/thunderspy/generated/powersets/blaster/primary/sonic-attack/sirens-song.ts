...
export const SirensSong: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.054,1,9.5,"Ranged_Ones","Str","Magnitude","Self","Any",true,"No",null,null,null,1],
    ...
    ["Unmapped",null,0.5,1,0,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "damageTypes": [
    "Energy"
  ]
