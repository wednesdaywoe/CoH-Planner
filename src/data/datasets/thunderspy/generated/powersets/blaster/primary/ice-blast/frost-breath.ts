...
export const FrostBreath: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.827964,1,0.6,"Ranged_Damage","Abs","Magnitude","Target","PvP",true,"No",null,null,0.5,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "damageTypes": [
    "Cold"
  ]
