...
export const DrainPsyche: Power = {
  ...
  "atoms": [
    ...
    ["Regeneration",null,-5,1,30,"Melee_Ones","Cur","Magnitude","Unspecified","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ]
};
