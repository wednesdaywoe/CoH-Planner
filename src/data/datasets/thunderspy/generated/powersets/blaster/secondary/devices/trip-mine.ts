...
export const TripMine: Power = {
  ...
  "atoms": [
    ["EntCreate",null,1,1,260,"Ranged_Level","Cur","Magnitude","Unspecified","Any",true,"No",null,null,null,1],
    ["Unmapped",null,0.264,1,11.5,"Ranged_Ones","Cur","Magnitude","Unspecified","Any",true,"No",null,null,null,1]
  ]
};
