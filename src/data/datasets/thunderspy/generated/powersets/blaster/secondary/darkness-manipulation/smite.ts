...
export const Smite: Power = {
  ...
  "atoms": [
    ...
    ["Unmapped",null,0.064,1,8.47,"Melee_Ones","Str","Magnitude","Self","Any",true,"No",null,null,null,1],
    ["Unmapped",null,0.454631,1,0,"Melee_Damage","Abs","Magnitude","Target","PvP",true,"No",null,null,null,1,null,null,null,null,null,null,"enttype target> player eq",true]
  ],
  "damageTypes": [
    "Negative",
    "Smashing"
