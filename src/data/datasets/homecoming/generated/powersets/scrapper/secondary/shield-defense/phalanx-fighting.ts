...
export const PhalanxFighting: Power = {
  ...
  "atoms": [
    ...
    ["Defense","Ranged",0.3,1,1,"Melee_Buff_Def","Cur","Magnitude","Self","Any",false,"No",2,null,null,1,null,null,null,null,null,null,"entref target> entref source> eq ! enttype target> player eq &&",true],
    ["Defense","Melee",0.3,1,1,"Melee_Buff_Def","Cur","Magnitude","Self","Any",false,"No",2,null,null,1,null,null,null,null,null,null,"entref target> entref source> eq ! enttype target> player eq &&",true],
    ["Defense","AoE",0.3,1,1,"Melee_Buff_Def","Cur","Magnitude","Self","Any",false,"No",2,null,null,1,null,null,null,null,null,null,"entref target> entref source> eq ! enttype target> player eq &&",true]
  ],
