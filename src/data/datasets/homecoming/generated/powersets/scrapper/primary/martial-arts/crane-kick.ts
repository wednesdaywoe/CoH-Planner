...
export const CraneKick: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Knockback",3,1,0,"Melee_Knockback","Cur","Magnitude","Target","Any",true,"Stack",2,null,null,0.6000000238418579],
    ...
    ["Damage","Smashing",1.9689,1,0,"Melee_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,0.05000000074505806],
    ["Mez","Knockback",3,1,0,"Melee_Knockback","Cur","Magnitude","Target","Any",true,"Stack",2,null,null,0.6000000238418579]
  ],
  "specialEffects": [
    {
