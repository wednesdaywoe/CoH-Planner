...
export const EaglesClaw: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Smashing",2.28,1,0,"Melee_InherentDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,0.15000000596046448],
    ...
    ["Damage","Smashing",2.651,1,0,"Melee_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,0.15000000596046448]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
