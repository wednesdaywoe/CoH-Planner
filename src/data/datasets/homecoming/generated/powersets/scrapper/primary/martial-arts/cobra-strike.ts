...
export const CobraStrike: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Smashing",1.9869,1,0,"Melee_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,0.05000000074505806,null,null,null,null,null,null,null,true],
    ["Mez","Stunned",1,3,0,"Melee_PvPMez","Cur","Duration","Target","Any",true,"Stack",2,null,null,0.75,null,null,null,null,null,null,null,true]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
