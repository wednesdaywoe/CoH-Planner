...
export const CobraStrike: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Stunned",10,3,0,"Melee_Stun","Cur","Duration","Target","Any",true,"Stack",2,null,null,0.75],
    ...
    ["Damage","Smashing",1.9869,1,0,"Melee_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,0.05000000074505806],
    ["Mez","Stunned",1,3,0,"Melee_PvPMez","Cur","Duration","Target","Any",true,"Stack",2,null,null,0.75]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
