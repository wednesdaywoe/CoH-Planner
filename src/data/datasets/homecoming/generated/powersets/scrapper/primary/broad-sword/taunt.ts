...
export const Taunt: Power = {
  ...
  "atoms": [
    ...
    ["Meta",null,1,1,0,"Melee_Ones","Cur","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,["enttype","target>","player","eq","enttype","target>","player","eq","@ToHitRoll","@ToHit",">=","@ForceHit","||","&&","&&"],true,null,null,null,null,null,null,null,null,null,null,"null"]
  ]
};
