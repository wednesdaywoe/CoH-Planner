...
export const SeismicSmash: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Smashing",2.2499,1,0,"Melee_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> player eq"],
    ...
    ["Damage","Smashing",0.63,1,0,"Melee_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,0.10000000149011612],
    ["Mez","Held",1,3,0,"Melee_PvPMez","Cur","Duration","Target","Any",true,"Stack",2,null,null,0.10000000149011612]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
