...
export const RockShards: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Lethal",0.7593,1,0,"Ranged_InherentDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,["enttype","target>","critter","eq"],null,null,null,null,null,null,null,0,null,"SentCrit,SentCritAoE",null,null,["Foe"]],
  ...
  "modeVariants": {
    "SeismicPower": {
      "internalName": "Sentinel_Rock_Shards_Large",
      "stats": {
        "accuracy": 1,
        "range": 60,
        "radius": 60,
      ...
      "atoms": [
        ...
        ["Damage","Smashing",1.2,1,0,"Ranged_InherentDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,["enttype","target>","critter","eq"],null,null,null,null,null,null,null,0,null,"SentCrit,SentCritAoE"],
