...
export const RockShards: Power = {
  ...
  "atoms": [
    ["Damage","Lethal",0.7593,1,0,"Ranged_Damage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1],
    ["Damage","Lethal",0.0759,1,3.1,"Melee_Damage","Abs","Magnitude","Target","Any",true,"Stack",2,null,1,1],
    ["Damage","Lethal",0.7593,1,0,"Ranged_InherentDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1],
