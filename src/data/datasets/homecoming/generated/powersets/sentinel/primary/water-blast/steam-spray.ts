...
export const SteamSpray: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Fire",0.6055,1,0.6,"Ranged_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,0.5,1],
    ["Damage","Fire",0.6055,1,0.6,"Ranged_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,0.5,1],
    ["Damage","Fire",1.4855,1,0.6,"Ranged_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,0.5,1],
    ["Damage","Fire",1.4855,1,0.6,"Ranged_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,0.5,1]
  ]
};
