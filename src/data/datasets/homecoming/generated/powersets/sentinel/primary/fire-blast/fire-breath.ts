...
export const FireBreath: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Fire",0.4489,1,2.1,"Ranged_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,1,1],
    ["Damage","Fire",0.4489,1,2.1,"Ranged_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,1,1],
    ["Damage","Fire",0.9697,1,2.1,"Ranged_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,1,1],
    ["Damage","Fire",0.9697,1,2.1,"Ranged_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,1,1]
  ]
};
