...
export const HeavyMallet: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Smashing",1.8109,1,0,"Melee_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,["enttype","target>","player","eq"],true],
