...
export const FlashBang: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Stunned",15,3,0,"Ranged_Stun","Cur","Duration","Target","Any",true,"Stack",2,null,null,1],
    ...
    ["Mez","Stunned",1,1,0,"Ranged_PvPMez","Cur","Duration","Target","Any",true,"Stack",2,null,null,1]
  ],
  "conditionalEffects": [
    {
      "id": "domination",
