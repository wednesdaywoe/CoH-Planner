...
export const MassConfusion: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Confused",30,3,0,"Ranged_Immobilize","Cur","Duration","Target","Any",true,"Stack",2,null,null,1],
    ...
    ["Mez","Confused",1,1,0,"Ranged_PvPMez","Cur","Duration","Target","Any",false,"Stack",2,null,null,1]
  ],
  "conditionalEffects": [
    {
      "id": "domination",
