...
export const WhirlingHands: Power = {
  ...
  "atoms": [
    ...
    ["RechargePower",null,1,1,0,"Ranged_Ones","Cur","Magnitude","Self","Any",false,"Ignore",2,null,null,1,null,true,null,null,null,null,"Redirects.Energy_Melee.Energy_Store_Assault source.ownPower?",true]
  ],
  "specialEffects": [
    {
      "kind": "effect-proc",
