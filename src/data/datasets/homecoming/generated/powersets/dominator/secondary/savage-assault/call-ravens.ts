...
export const CallRavens: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Lethal",0.2514,1,3.1,"Ranged_PvPDamage","Abs","Expression","Target","Any",true,"Stack",2,null,0.75,1,null,null,null,null,null,null,"enttype target> player eq",true],
