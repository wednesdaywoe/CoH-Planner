...
export const CallRavens: Power = {
  ...
  "atoms": [
    ["Damage","Lethal",0.241,1,3.1,"Ranged_Damage","Abs","Expression","Target","Any",true,"Stack",2,null,0.75,1,null,null,null,null,null,null,["enttype","target>","critter","eq"],null,null,null,null,null,["Temporary_Powers.Temporary_Powers.Savage_Melee_Blood_Frenzy_Stalker","source.ownPowerNum?",".014","*","1","+","@StdResult","*"],null,null,null,null,null,null,null,0.5],
    ...
    ["Damage","Lethal",0.2514,1,3.1,"Ranged_PvPDamage","Abs","Expression","Target","Any",true,"Stack",2,null,0.75,1,null,null,null,null,null,null,["enttype","target>","player","eq"],true,null,null,null,null,["Temporary_Powers.Temporary_Powers.Savage_Melee_Blood_Frenzy_Stalker","source.ownPowerNum?",".014","*","1","+","@StdResult","*"],null,null,null,null,null,null,null,0.5],
