...
export const Burst: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Lethal",0.4159,1,0.61,"Ranged_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,0.30000001192092896,1,null,null,null,null,null,null,"enttype target> player eq"],
