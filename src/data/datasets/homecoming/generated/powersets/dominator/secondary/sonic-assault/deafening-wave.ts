...
export const DeafeningWave: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Held",7.5,2,0,"Melee_Immobilize","Cur","Duration","Target","Any",true,"Stack",2,null,null,1],
    ["Damage","Smashing",0.4032,1,0,"Melee_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> player eq"],
    ["Damage","Energy",0.4032,1,0,"Melee_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> player eq"],
    ["Mez","Held",1,2,0,"Melee_PvPMez","Cur","Duration","Target","Any",true,"Stack",2,null,null,0.30000001192092896]
  ],
  "conditionalEffects": [
    {
      "id": "domination",
