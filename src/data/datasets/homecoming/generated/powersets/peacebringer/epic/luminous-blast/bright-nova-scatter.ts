...
export const BrightNovaScatter: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Energy",0.7544,1,0,"Ranged_InherentDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,"enttype target> player eq"]
  ],
