...
export const BreathofFire: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Fire",1.3732,1,0,"Melee_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1],
    ["Damage","Fire",0.3381,1,0.6,"Melee_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,0.5,1],
