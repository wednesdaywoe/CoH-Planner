...
export const SavageLeap: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Lethal",0.845,1,0,"Melee_InherentDamage","Abs","Expression","Target","Any",true,"Stack",2,null,null,0.07000000029802322,null,null,null,null,null,null,["enttype","target>","critter","eq","enttype","target>","critter","eq","kMeter","source>",".9","<","&&","&&"],null,null,null,null,null,["distance","25","-","0","40","minmax","40","/","1","+","@StdResult","*"],null,null,null,"ASTeamCrit",null,null,["Foe"]],
