...
export const AssassinsBlaze: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Fire",2.76,1,0,"Melee_Damage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,["kMeter","source>",".9","<","enttype","target>","critter","eq","&&"],null,null,null,null,null,null,null,null,null,null,null,null,["Foe"]],
    ["Damage","Fire",2.76,1,0,"Melee_InherentDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,0,null,null,null,null,null,null,["kMeter","source>",".9","<","enttype","target>","critter","eq","&&"],null,null,null,null,null,null,null,null,null,"ASCrit",null,null,["Foe"]]
  ],
  "formVariants": [
    {
      "condition": [
      ...
      "internalName": "Assassins_Blaze_Quick",
      "stats": {
        "accuracy": 1.2,
        "range": 7,
        "recharge": 15,
    ...
    },
    {
      ...
      "internalName": "Assassins_Blaze_Stealth",
      "stats": {
        "accuracy": 1.2,
        "range": 7,
        "recharge": 15,
