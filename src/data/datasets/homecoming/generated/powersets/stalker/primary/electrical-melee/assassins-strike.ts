...
export const AssassinsStrike: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Energy",2.76,1,0,"Melee_Damage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,"kMeter source> .9 < enttype target> critter eq &&"],
