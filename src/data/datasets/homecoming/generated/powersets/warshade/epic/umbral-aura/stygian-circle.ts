...
export const StygianCircle: Power = {
  ...
  "atoms": [
    ...
    ["Heal",null,2,1,0,"Melee_HealSelf","Abs","Magnitude","Self","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,["arch","target>","Class_Lt_Grunt","eq","!","arch","target>","Class_Lt_Sniper","eq","!","&&","arch","target>","Class_Boss_Grunt","eq","!","&&","arch","target>","Class_Boss_Elite","eq","!","&&","arch","target>","Class_Boss_Archvillain","eq","!","&&","arch","target>","Class_Boss_Monster","eq","!","&&","enttype","target>","player","eq","!","&&"],true],
