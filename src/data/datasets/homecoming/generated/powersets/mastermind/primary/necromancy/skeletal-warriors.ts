...
export const SkeletalWarriors: Power = {
  ...
  "atoms": [
    ...
    ["EntCreate",null,-1,1,99999,"Ranged_Ones","Cur","Magnitude","Target","Any",false,"Ignore",2,null,null,1,null,true,null,null,null,null,"combatlevel source> 23 >"],
    ["RechargePower",null,35,1,0,"Ranged_Ones","Cur","Magnitude","Self","PvP",true,"Ignore",2,null,null,1]
  ]
};
