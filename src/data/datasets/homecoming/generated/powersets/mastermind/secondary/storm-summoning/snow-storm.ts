...
export const SnowStorm: Power = {
  ...
  "atoms": [
    ...
    ["Movement","Run",-1.5,1,0.75,"Ranged_SpeedRunning","Max","Magnitude","Target","Any",true,"Replace",2,null,null,1,null,true,null,null,null,null,["enttype","target>","critter","eq"]]
  ]
};
