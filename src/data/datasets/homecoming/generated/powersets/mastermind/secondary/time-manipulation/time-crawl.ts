...
export const TimeCrawl: Power = {
  ...
  "atoms": [
    ...
    ["Regeneration",null,-4,1,20,"Ranged_Res_Boolean","Cur","Magnitude","Target","Any",true,"Replace",2,null,null,1,null,true,null,null,null,null,"enttype target> player eq"]
  ]
};
