...
export const EnfeeblingLullaby: Power = {
  ...
  "atoms": [
    ...
    ["Mez","Sleep",8,1,0,"Ranged_Sleep","Cur","Duration","Target","Any",true,"Replace",2,null,null,0.5,null,null,null,null,null,null,["enttype","target>","critter","eq","Raid","target.HasTag?","!","&&"],null,null,null,null,null,null,null,null,null,"Overpower",null,null,null,0.25],
    ...
    ["Mez","Sleep",8,1,0,"Ranged_Sleep","Cur","Duration","Target","Any",true,"Replace",2,null,null,0.5,null,null,null,null,null,null,["enttype","target>","critter","eq"],null,null,null,null,null,null,null,null,null,"Overpower",null,null,null,0.25],
    ...
    ["Damage","Psionic",0.2,1,0,"Ranged_InherentDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,null,1,null,null,null,null,null,null,["kTerrorized","target>","0",">","kImmobilized","target>","0",">","||","kHeld","target>","0",">","||","kStunned","target>","0",">","||","Sleep","target.EventTimeSince>","3","<=","||","IncarnateBoss","target.HasTag?","||"],true,null,null,null,null,null,null,null,null,"Containment"],
