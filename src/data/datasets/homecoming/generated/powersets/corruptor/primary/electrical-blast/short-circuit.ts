...
export const ShortCircuit: Power = {
  ...
  "atoms": [
    ...
    ["Damage","Energy",0.1475,1,2.1,"Ranged_PvPDamage","Abs","Magnitude","Target","Any",true,"Stack",2,null,0.5,1,null,null,null,null,null,null,"enttype target> player eq kHitPoints% target> 10 - 100 * 50 10 - / 0 100 minmax rand 100 * < &&",true,null,null,null,null,null,null,null,null,"Scourge"],
