 ...
 * Archetype: corruptor
 * Category: secondary
 * Source: corruptor_buff/marine_affinity
 */
...
import { Wellspring as Wellspring } from './wellspring';
import { CallDepths as CallDepths } from './call-depths';

export const powerset: Powerset = {
  id: 'corruptor/marine-affinity',
  setPath: 'Corruptor_Buff.Marine_Affinity',
