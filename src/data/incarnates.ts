 ...
 * Slot indices are vendored from the bin-crawler export into
 * `src/data/incarnate-indices/<slot>.json`. Regenerate with
 * `tools/bin-crawler/bin_crawler/export_powers.py` and copy the per-slot
 * `index.json` files in.
 */
...
// Import slot index files (bin-crawler shape, vendored into src/data/)
import alphaIndex from './incarnate-indices/alpha.json';
import judgementIndex from './incarnate-indices/judgement.json';
import interfaceIndex from './incarnate-indices/interface.json';
