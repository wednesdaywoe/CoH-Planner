...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  // IMPORT / EXPORT
  {
    ...
    description: "Import builds from Mids' Reborn (.mbd files or data chunks). Open the Load / Import tab and select Mids Reborn as the source, then paste the data or upload a .mbd file.",
    keywords: ['mids', 'import', 'mbd', 'reborn', 'paste', 'upload', 'file'],
    steps: [
      'Open the File menu and click Load / Import',
      'Select "Mids Reborn (.mbd)" as the source',
  ...
  },
  {
    ...
    category: 'import-export',
    description: 'Share your build with others by generating a shareable link. Open the Share / Export tab, select Share Publicly, optionally add a description and author name, then click Share. The URL can be shared with anyone.',
  ...
  },
  {
    ...
    category: 'import-export',
    description: 'Save builds locally using the Save tab (download .skif) or save to your vault if logged in. Load builds from the Load / Import tab.',
  ...
  },
  {
    ...
    category: 'import-export',
    description: 'Export your build as a .mbd file that can be opened in Mids\' Reborn. Open the Share / Export tab and select Export Utilities. This feature is experimental — some enhancements or power naming differences may not transfer perfectly.',
