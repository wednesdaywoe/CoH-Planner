/**
 * Psychokinetic Barrier (internal name: Fortify_Mind) — GENERATED LAYER
 * AUTO-GENERATED by `node scripts/convert-powerset.cjs tanker_defense psionic_armor`.
 * Do not hand-edit. Manual deltas live in
 * src/data/overrides/powersets/tanker/primary/psionic-armor/fortify-mind.ts.
 *
 * Source: tanker_defense/psionic_armor/fortify_mind.json (CoD2 raw)
 */
