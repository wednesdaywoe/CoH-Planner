...
const STAT_CATEGORIES: {
  ...
  },
  {
    ...
    stats: [
      ...
      { stat: 'mez_hold', label: 'Hold Res' },
      { stat: 'mez_stun', label: 'Stun Res' },
      { stat: 'mez_immob', label: 'Immob Res' },
      { stat: 'mez_sleep', label: 'Sleep Res' },
      { stat: 'mez_confuse', label: 'Confuse Res' },
      { stat: 'mez_fear', label: 'Fear Res' },
      { stat: 'mez_kb', label: 'KB Res' },
    ],
  },
  {
    name: 'Endurance',
