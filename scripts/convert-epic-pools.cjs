...
const OUTPUT_PATH = path.resolve('./src/data/generated/epic-pools.ts');
const COMPOSED_PATH = path.resolve('./src/data/epic-pools-raw.ts');
const OVERRIDES_PATH = path.resolve('./src/data/overrides/epic-pools.ts');
