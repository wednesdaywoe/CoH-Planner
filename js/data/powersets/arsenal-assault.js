/**
 * Arsenal Assault - Blaster Primary
 * Extracted from raw_data_homecoming with updated converter
 */

const ARSENAL_ASSAULT_POWERSET = {
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['arsenal-assault'] = ARSENAL_ASSAULT_POWERSET;
} else if (typeof window !== 'undefined') {
    window.ARSENAL_ASSAULT_POWERSET = ARSENAL_ASSAULT_POWERSET;
}