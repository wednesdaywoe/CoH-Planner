...
const TEMPORAL_MANIPULATION_POWERSET = {
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['temporal-manipulation'] = TEMPORAL_MANIPULATION_POWERSET;
} else if (typeof window !== 'undefined') {
    window.TEMPORAL_MANIPULATION_POWERSET = TEMPORAL_MANIPULATION_POWERSET;
}