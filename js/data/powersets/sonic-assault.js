/**
 * Sonic Assault - Blaster Primary
 * Extracted from raw_data_homecoming with updated converter
 */

const SONIC_ASSAULT_POWERSET = {
    name: "Sonic Assault",
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['sonic-assault'] = SONIC_ASSAULT_POWERSET;
} else if (typeof window !== 'undefined') {
    window.SONIC_ASSAULT_POWERSET = SONIC_ASSAULT_POWERSET;
}