/**
 * Psionic Melee - Blaster Primary
 * Extracted from raw_data_homecoming with updated converter
 */

const PSIONIC_MELEE_POWERSET = {
    name: "Psionic Melee",
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['psionic-melee'] = PSIONIC_MELEE_POWERSET;
} else if (typeof window !== 'undefined') {
    window.PSIONIC_MELEE_POWERSET = PSIONIC_MELEE_POWERSET;
}