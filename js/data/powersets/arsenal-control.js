/**
 * Arsenal Control - Blaster Primary
 * Extracted from raw_data_homecoming with updated converter
 */

const ARSENAL_CONTROL_POWERSET = {
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['arsenal-control'] = ARSENAL_CONTROL_POWERSET;
} else if (typeof window !== 'undefined') {
    window.ARSENAL_CONTROL_POWERSET = ARSENAL_CONTROL_POWERSET;
}