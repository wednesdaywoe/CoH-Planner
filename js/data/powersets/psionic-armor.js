/**
 * Psionic Armor - Blaster Primary
 * Extracted from raw_data_homecoming with updated converter
 */

const PSIONIC_ARMOR_POWERSET = {
    name: "Psionic Armor",
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['psionic-armor'] = PSIONIC_ARMOR_POWERSET;
} else if (typeof window !== 'undefined') {
    window.PSIONIC_ARMOR_POWERSET = PSIONIC_ARMOR_POWERSET;
}