/**
 * Ninja Sword - Blaster Primary
 * Extracted from raw_data_homecoming with updated converter
 */

const NINJA_SWORD_POWERSET = {
    name: "Ninja Sword",
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['ninja-sword'] = NINJA_SWORD_POWERSET;
} else if (typeof window !== 'undefined') {
    window.NINJA_SWORD_POWERSET = NINJA_SWORD_POWERSET;
}