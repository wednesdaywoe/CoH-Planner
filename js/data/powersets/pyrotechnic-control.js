/**
 * Pyrotechnic Control - Blaster Primary
 * Extracted from raw_data_homecoming with updated converter
 */

const PYROTECHNIC_CONTROL_POWERSET = {
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['pyrotechnic-control'] = PYROTECHNIC_CONTROL_POWERSET;
} else if (typeof window !== 'undefined') {
    window.PYROTECHNIC_CONTROL_POWERSET = PYROTECHNIC_CONTROL_POWERSET;
}