/**
 * Martial Manipulation - Blaster Primary
 * Extracted from raw_data_homecoming with updated converter
 */

const MARTIAL_MANIPULATION_POWERSET = {
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['martial-manipulation'] = MARTIAL_MANIPULATION_POWERSET;
} else if (typeof window !== 'undefined') {
    window.MARTIAL_MANIPULATION_POWERSET = MARTIAL_MANIPULATION_POWERSET;
}