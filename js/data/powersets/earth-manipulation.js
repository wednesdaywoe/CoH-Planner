/**
 * Earth Manipulation - Blaster Primary
 * Extracted from raw_data_homecoming with updated converter
 */

const EARTH_MANIPULATION_POWERSET = {
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['earth-manipulation'] = EARTH_MANIPULATION_POWERSET;
} else if (typeof window !== 'undefined') {
    window.EARTH_MANIPULATION_POWERSET = EARTH_MANIPULATION_POWERSET;
}