/**
 * Radiation Manipulation - Blaster Primary
 * Extracted from raw_data_homecoming with updated converter
 */

const RADIATION_MANIPULATION_POWERSET = {
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['radiation-manipulation'] = RADIATION_MANIPULATION_POWERSET;
} else if (typeof window !== 'undefined') {
    window.RADIATION_MANIPULATION_POWERSET = RADIATION_MANIPULATION_POWERSET;
}