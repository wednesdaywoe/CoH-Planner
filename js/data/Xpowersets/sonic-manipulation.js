/**
 * Sonic Manipulation - Blaster Primary
 * Extracted from raw_data_homecoming with updated converter
 */

const SONIC_MANIPULATION_POWERSET = {
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['sonic-manipulation'] = SONIC_MANIPULATION_POWERSET;
} else if (typeof window !== 'undefined') {
    window.SONIC_MANIPULATION_POWERSET = SONIC_MANIPULATION_POWERSET;
}