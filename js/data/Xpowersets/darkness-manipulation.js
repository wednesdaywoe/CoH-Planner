/**
 * Darkness Manipulation - Blaster Primary
 * Extracted from raw_data_homecoming with updated converter
 */

const DARKNESS_MANIPULATION_POWERSET = {
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['darkness-manipulation'] = DARKNESS_MANIPULATION_POWERSET;
} else if (typeof window !== 'undefined') {
    window.DARKNESS_MANIPULATION_POWERSET = DARKNESS_MANIPULATION_POWERSET;
}