...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['electricity-manipulation'] = ELECTRICITY_MANIPULATION_POWERSET;
} else if (typeof window !== 'undefined') {
    window.ELECTRICITY_MANIPULATION_POWERSET = ELECTRICITY_MANIPULATION_POWERSET;
}