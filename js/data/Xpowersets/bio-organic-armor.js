/**
 * Bio Organic Armor - Blaster Primary
 * Extracted from raw_data_homecoming with updated converter
 */

const BIO_ORGANIC_ARMOR_POWERSET = {
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['bio-organic-armor'] = BIO_ORGANIC_ARMOR_POWERSET;
} else if (typeof window !== 'undefined') {
    window.BIO_ORGANIC_ARMOR_POWERSET = BIO_ORGANIC_ARMOR_POWERSET;
}