/**
 * Kinetic Attack - Blaster Primary
 * Extracted from raw_data_homecoming with updated converter
 */

const KINETIC_ATTACK_POWERSET = {
    name: "Kinetic Attack",
...
if (typeof POWERSETS !== 'undefined') {
    POWERSETS['kinetic-attack'] = KINETIC_ATTACK_POWERSET;
} else if (typeof window !== 'undefined') {
    window.KINETIC_ATTACK_POWERSET = KINETIC_ATTACK_POWERSET;
}